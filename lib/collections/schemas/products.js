...
export const Product = new SimpleSchema({
  ...
  isLowQuantity: {
    label: "Indicates that the product quantity is too low",
    type: Boolean,
    defaultValue: false // default warn at is 0 (don't warn)
  },
  isSoldOut: {
    label: "Indicates when the product quantity is zero",
    type: Boolean,
    defaultValue: true // products default to having 0 inventory
  },
  isBackorder: {
    label: "Indicates when the seller has allowed the sale of product which" +
    " is not in stock",
    type: Boolean,
    defaultValue: true // defaulting true to match the UI defaults
  },
  requiresShipping: {
